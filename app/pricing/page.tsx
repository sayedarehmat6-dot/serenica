...
<h1 className="text-4xl font-bold text-center text-cyan-400">Pricing</h1>
...
<button className="mt-6 w-full py-2 rounded bg-cyan-500 hover:bg-cyan-400">Subscribe</button>
</div>
))}
</div>
</div>
